# How to contribute to Landelijke Docs

We're glad for your interest in contributing to our project. Landelijke Docs is open-source, and as such, anyone can contribute! The process is really simple.

You are welcome to contribute to our platform in two ways.
Create a new Codeberg Issue

Head over to our issue page on Codeberg to let us know about bugs, feature requests for the website, or anything that you would love to see developed for your research project (e.g., a code snippet). You can also attach files.
...
We basically welcome any kind of feedback and contribution, including but not limited to:
    ...
    - uploading your own guides, articles, courses, and walk throughs
    - linking 3rd party learning resources you have found useful
    - reporting a bug
...
Kindly stolen form Tilburg Uni

...
Accordingly, everyone who participates in the Landelijke Docs project is expected to show respect and courtesy to other community members at all times.

The *Landelijke Docs* community is dedicated to a ***welcoming and harassment-free experience for everyone***, regardless of gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, race, age or religion. **We do not tolerate harassment by and/or of members of our community in any form**.
...
Landelijke Docs is a community-oriented and -led project.
...
To make clear what is expected, everyone participating in activities associated with the Landelijke Docs project is required to conform to this Code of Conduct.
This Code of Conduct applies to all spaces managed by the Landelijke Docs project including, but not limited to, in-person focus groups and workshops, and communications online via Codeberg.

### Contact for Reporting

The _Landelijke Docs_ project delivery team, listed in the [Governance Roles documentation](https://github.com/the-turing-way/the-turing-way/blob/main/GOVERNANCE_ROLES.md), are responsible for enforcing the Code of Conduct.
...
The Landelijke Docs team are dedicated to providing a welcoming and supportive environment for all people, regardless of background or identity.
...
Everyone who participates in the Landelijke Docs project activities is required to conform to this Code of Conduct.
This Code of Conduct applies to all spaces managed by the Landelijke Docs project including, but not limited to, in-person focus groups and workshops, and communications online via Codeberg.
By participating, contributors indicate their acceptance of the procedures by which the Landelijke Docs project core development team resolves any Code of Conduct incidents, which may include the storage and processing of their personal information.
...
Rather, you are invited to make suggestions for updates or clarifications by contacting the *Landelijke Docs* Project Delivery Team by making a pull request to this document on Codeberg or raising it as an issue.

# 3 Incident Reporting Guidelines

## 3.1 Contact points

If you feel able to, please contact _Landelijke Docs_ project delivery team by emailing [turingway@turing.ac.uk](mailto:turingway@turing.ac.uk) who is responsible for enforcing the Code of Conduct.
...
This can include contacting law enforcement (or other local personnel) and speaking on behalf of Landelijke Docs team.
...
* A public announcement of an incident, ideally in the same venue that the violation occurred (such as on the listserv for a listserv violation; and Codeberg for a Codeberg violation).
...
* A permanent or temporary ban from some or all Landelijke Docs project spaces (like on Codeberg, online calls or in-person events).
